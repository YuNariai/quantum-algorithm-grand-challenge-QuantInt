...
from quri_parts.core.operator import Operator, SinglePauli, PauliLabel, PAULI_IDENTITY, is_hermitian
...
class ADAPT_VQE:
    ...
    def init_qubit_pool(self):
        ...
        for fermionOp in pool:
            ...
            for pauli in qubitOp.terms:
                ...
                qubitOp = QubitOperator(new_pauli, 1)
                found = False
    ...
    def get_operator_gradient(self, index, qc_type):
        ...
        zne_estimated_value = zne_parametric_estimator(
            ...
            self.params)
        aa = 2 * zne_estimated_value.value.real
        #print(aa)
        return aa
        '''
